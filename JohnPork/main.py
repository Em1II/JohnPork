...
quotes = [["Не кладите все яйца в одну корзину, если вы не свинья с очень большой корзиной", "Дж. Порк, 2013г"], 
          ...
          ["Porks - это свиная сила, с которой нужно считаться", "Дж. Порк, 2003г"], 
          ["Если у вас есть порки, вам не нужны деньги", "Дж. Порк, 2001г"], 
          ["Я не криптомиллионер. Я свино-миллионер", "Дж. Порк, 2021г"], 
          ["В мире криптовалют свиньи правят балом", "Дж. Порк, 2024г"], 
          ["Не будьте свиньей, которая продаст своих порков за пару трюфелей", "Дж. Порк, 2004г"], 
...
def get_last_dialog(id):
    ...
    if dialogs:
        ...
        dialog = dialogs[0]
        return dialog.response, " Дж. Порк в ответ на ваше последнее письмо"
    return "Зарегистрируйтесь прямо сейчас, и начните общение с вашим кумиром прямо сейчас", ""
def get_news(amount):
    db = db_session.create_session()
